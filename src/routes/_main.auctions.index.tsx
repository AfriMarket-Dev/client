...
export const Route = createFileRoute("/_main/auctions/")({
	...
	loaderDeps: ({ search }) => ({
		searchQuery: search.searchQuery || search.q || "",
	...
	head: () =>
		createSeoMeta({
			...
			description:
				"Participate in live wholesale auctions on Karibu. Bid on quality products from verified African providers and get the best prices.",
			keywords: [
