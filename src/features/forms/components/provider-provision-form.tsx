...
import {
	type ProviderProvisionValues,
	providerProvisionOptions,
} from "@/shared/schemas/business";
import { AgentStep } from "./provider-provision/agent-step";
import { IdentityStep } from "./provider-provision/identity-step";
import { ReviewStep } from "./provider-provision/review-step";

interface ProviderProvisionFormProps {
	currentStep: number;
	onStepChange: (step: number) => void;
	onSubmit: (values: ProviderProvisionValues) => void;
	onCancel: () => void;
	initialValues?: Partial<ProviderProvisionValues>;
	mode?: "add" | "edit";
}

export const ProviderProvisionForm: React.FC<ProviderProvisionFormProps> = ({
	currentStep,
	onStepChange,
	onSubmit,
	onCancel,
	...
	const form = useForm({
		...providerProvisionOptions,
		defaultValues: {
			...providerProvisionOptions.defaultValues,
			...initialValues,
