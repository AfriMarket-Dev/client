...
import { AdminProvidersPage } from "../components/providers-page";
...
describe("AdminProviderManagement Integration", () => {
	it("allows suspending an active provider from the list", async () => {
		...
		await screen.findByText("Active Provider Ltd");
