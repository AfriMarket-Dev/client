...
interface ProviderAssignedService {
	id: string;
	name: string;
	description: string;
	assignedDate: string;
...
interface ProviderOwnedProduct {
	id: string;
	name: string;
	category: string;
...
/**
 * Component that can be integrated into the Provider Dashboard
 * Shows providers their assigned services and products
 */
export default function ProviderServicesAndProducts() {
	// Mock data - would be fetched from API with provider ID
	const assignedServices: ProviderAssignedService[] = [
		{
			id: "1",
	...
	const ownedProducts: ProviderOwnedProduct[] = [
		{
			id: "1",
		...
		<div className="space-y-8">
			...
			<div className="bg-info/10 rounded-sm p-6 border border-info/30">
				...
				<p className="text-sm text-info">
					This component can be integrated into your existing Provider Dashboard
					page. It shows providers their assigned services and the products they
