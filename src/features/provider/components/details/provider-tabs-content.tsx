...
import { AddReviewDialog } from "@/features/marketplace/components/reviews/add-review-dialog";
import { ReviewList } from "@/features/marketplace/components/reviews/review-list";
					...
					<div className="md:col-span-2 space-y-12">
						...
						<section className="space-y-4">
							...
							<p className="text-sm text-muted-foreground leading-relaxed">
								{company.description ||
									"No detailed description available for this provider."}
							</p>
						</section>
						...
						<SpecificationList
							...
							specifications={{
								...
								"Operating Since": company.createdAt
