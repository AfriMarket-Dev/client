...
import { ProviderContactBar } from "./provider-contact-bar";
			...
			<div className="space-y-6">
				<div>
					...
					<p className="text-muted-foreground leading-relaxed max-w-3xl">
						{company.description ||
							"Leading provider of construction materials and specialized services across Rwanda. Providing high-quality supplies and dedicated support for your projects."}
					</p>
				</div>
