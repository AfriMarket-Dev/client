...
const SupplierListing: React.FC<SupplierListingProps> = ({
  ...
  const isDummyMode = !listData?.data && mockCompanies.length > 0;
    ...
    <div className="space-y-6 p-1">
      ...
      <div className="space-y-4">
        ...
        <Select
          ...
          onValueChange={(val) => handleFiltersChange({ categoryId: val })}
        >
      ...
      <div className="space-y-4">
        ...
        <Select
          value={filters.type}
          onValueChange={(val) => handleFiltersChange({ type: val })}
        >
          <SelectTrigger className="w-full bg-background">
      ...
      <div className="space-y-4">
        ...
        <Select
          ...
          onValueChange={(val) => handleFiltersChange({ minRating: val })}
        >
          <SelectTrigger className="w-full bg-background">
