...
import type { ProductCategory } from "@/app/api/product-categories";
import type { CreateProductInput } from "@/app/api/products";
...
export function ListingForm({
	...
	>(
		(defaultValues?.priceType as "FIXED" | "NEGOTIABLE" | "STARTS_AT") ??
			"FIXED",
	);
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				...
				<div>
					...
					<select
						...
						onChange={(e) =>
							setPriceType(
								e.target.value as "FIXED" | "NEGOTIABLE" | "STARTS_AT",
							)
						}
						className="w-full h-11 px-3 rounded-sm border border-border bg-background text-foreground"
					>
