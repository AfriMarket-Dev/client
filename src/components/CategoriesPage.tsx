                  ...
                  <div className="absolute top-0 right-0 w-32 h-32 opacity-10">
                    ...
                    >
                      ...
                      <rect
                        width="128"
                        height="128"
                        fill={`url(#category-pattern-${index})`}
                      />
                    </svg>
                  </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      ...
                      {category.subcategories.length > 3 && (
                        <span className="px-3 py-1.5 bg-muted text-muted-foreground text-xs font-medium rounded-full border border-border">
                    ...
                    <Button
                      variant="outline"
                      className="w-full border-2 border-primary/20 text-primary bg-card hover:bg-gradient-to-r hover:from-primary hover:to-primary/90 hover:text-white hover:border-transparent transition-all duration-300 shadow-sm hover:shadow-lg py-6 h-auto rounded-2xl"
                    >
          ...
          <div className="space-y-8">
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">
                Suppliers in {selectedCategoryData?.name} (
              ...
              categoryDetails.suppliers.length > 0 ? (
                ...
                <div className="text-center py-12 bg-card rounded-2xl">
                  ...
                  <p className="text-muted-foreground">
                    No suppliers currently available in this category
                  </p>
                </div>
              )}
            </div>
