...
import { ArrowLeft, Star, MapPin, CheckCircle, Phone, Mail, MessageCircle, Globe, Package, Truck, Shield, Clock, Award, Users, TrendingUp, Heart, Eye, Filter, Grid, List, Send, User, Building, Calendar, Verified, X, Paperclip, Smile } from 'lucide-react';
...
const SupplierDetails: React.FC<SupplierDetailsProps> = ({ supplierId, onBack, onProductClick }) => {
  const { addToWishlist, removeFromWishlist, isInWishlist } = useWishlist();
  const supplier = suppliers.find(s => s.id === supplierId);
  const supplierProducts = products.filter(p => p.supplierId === supplierId);
  
  const [activeTab, setActiveTab] = useState<'overview' | 'products' | 'reviews' | 'contact'>('overview');
  ...
  const handleInquirySubmit = (e: React.FormEvent) => {
    ...
    // Reset form
    setInquiryForm({
      name: '', email: '', company: '', phone: '', subject: '', message: '', productInterest: '', orderQuantity: ''
    });
  };
    ...
    if (chatMessage.trim()) {
      ...
      setTimeout(() => {
        const supplierResponse = {
          ...
          sender: 'supplier',
          message: 'Thank you for your message! I\'ll get back to you with more details shortly.',
          timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
          isOwn: false
        };
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setInquiryForm({...inquiryForm, productInterest: e.target.value})}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setInquiryForm({...inquiryForm, orderQuantity: e.target.value})}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent"
      ...
      <div className="relative bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" viewBox="0 0 1200 400">
            <defs>
              <pattern id="supplier-pattern" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                <polygon points="40,10 60,30 40,50 20,30" fill="currentColor" opacity="0.3"/>
                <circle cx="40" cy="40" r="12" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.2"/>
                <path d="M20,20 L60,60 M60,20 L20,60" stroke="currentColor" strokeWidth="1" opacity="0.1"/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#supplier-pattern)" className="text-orange-600"/>
          </svg>
        </div>
            ...
            <div className="lg:col-span-2">
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">{supplier.description}</p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-orange-200/50 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">{supplier.services.minimumOrder}</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
              ...
              >
                ...
                {isInWishlist(supplier.id, 'supplier') ? 'Remove from Wishlist' : 'Add to Wishlist'}
              </button>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Services & Capabilities</h3>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Chat directly on platform</div>
                    </div>
                  </button>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
              <div>
                ...
                <p className="text-gray-600">Browse {supplierProducts.length} products from {supplier.name}</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">{new Date(supplier.joinedDate).getFullYear()}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">{supplier.totalProducts} items</div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">{supplier.rating}/5.0 ({supplier.reviewCount} reviews)</div>
                  </div>
                </div>
              </div>
            </div>
