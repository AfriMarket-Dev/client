...
export default function ServiceView({ service, onBack }: ServiceViewProps) {
	...
	const [startListingChat, { isLoading: sendingInquiry }] =
							...
							<div className="grid md:grid-cols-2 gap-8">
								...
								<div className="space-y-6">
									...
									<div className="grid gap-4">
										<a
											href="#"
											className="flex items-center gap-4 p-4 border border-border bg-background hover:border-primary/50 hover:bg-muted/10 transition-colors group"
										>
										...
										>
											...
											<div>
												...
												<div className="font-bold text-foreground text-emerald-600">
													+27 21 000 0000
												</div>
											</div>
										</a>
