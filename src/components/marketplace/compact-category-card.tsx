			...
			<div className="space-y-1 mb-4 flex-1">
				{(
					...
					.map((sub, idx) => (
						<div
							key={idx}
							className="flex items-center gap-1.5 text-xs text-muted-foreground/80 hover:text-foreground cursor-pointer group/sub"
						>
							<RiArrowRightSLine
								size={10}
								className="text-primary/50 group-hover/sub:text-primary"
							/>
							{sub}
						</div>
					))}
