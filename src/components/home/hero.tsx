...
import { RiArrowRightLine, RiFlashlightLine } from "@remixicon/react";
...
const MOCK_WIDGET_ITEMS: Record<string, HeroWidgetItem[]> = {
	deals: [
		...
		},
		{
			...
			image:
				"https://images.unsplash.com/photo-1509453721491-c3af5961df76?q=80&w=735&auto=format&fit=crop",
			price: 12000,
			label: "-25%",
		},
		{
			...
			image:
				"https://images.unsplash.com/photo-1667339242123-3c1f5fd9a3b0?q=80&w=1170&auto=format&fit=crop",
			price: 156000,
			label: "-40%",
		},
	],
	products: [
		...
		},
		{
			...
			image:
				"https://images.unsplash.com/photo-1535732759880-bbd5c7265e3f?auto=format&fit=crop&q=80&w=300",
			price: "9,500",
			label: "TRENDING",
			subtext: "Steel",
		},
	...
	services: [
		...
		},
		{
			...
			name: "Bulk Shipping",
			image:
				"https://images.unsplash.com/photo-1494412574643-ff11b0a5c1c3?auto=format&fit=crop&q=80&w=300",
...
const MOCK_CAROUSEL_ITEMS = [
	...
	},
	{
		id: 3,
		image:
			"https://images.unsplash.com/photo-1535732759880-bbd5c7265e3f?auto=format&fit=crop&q=80&w=2000",
									...
									<div className="relative h-[220px] md:h-[320px] lg:h-[380px] w-full overflow-hidden flex items-center">
										...
										<div className="relative z-20 p-5 md:p-8 lg:p-16 max-w-3xl w-full">
											<div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-6">
												...
												>
													<RiFlashlightLine className="w-3 h-3 md:w-3.5 md:h-3.5 mr-1.5 fill-current" />
													{item.tag}
												</Badge>
											...
											<div className="flex gap-4">
												...
												>
													Shop Now{" "}
													<RiArrowRightLine className="ml-2 md:ml-3 w-4 h-4 group-hover:translate-x-1 transition-transform" />
												</Button>
											</div>
										</div>
									</div>
