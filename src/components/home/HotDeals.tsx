  ...
  return (
    <>
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-12 gap-6">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-4">
            <Badge variant="destructive" className="rounded-lg px-3 py-1 h-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 border-l border-border/40 pl-8 hidden md:flex">
           <div className="text-left sm:text-right">
               <div className="text-[10px] font-bold text-muted-foreground/50 mb-3 uppercase tracking-[0.25em]">Offer Ends In</div>
               <div className="flex gap-2 text-3xl font-bold font-sans text-foreground">
                  <div className="bg-white border border-border/50 px-3 py-2 rounded-lg min-w-14 text-center">05</div>
                  <span className="self-center text-muted-foreground/20 font-heading">:</span>
                  <div className="bg-white border border-border/50 px-3 py-2 rounded-lg min-w-14 text-center">42</div>
                  <span className="self-center text-muted-foreground/20 font-heading">:</span>
                  <div className="bg-white border border-border/50 px-3 py-2 rounded-lg min-w-14 text-center text-red-600">18</div>
               </div>
           </div>
      ...
      <div className="mt-10 text-center md:hidden">
          ...
          variant="outline"
          size="lg"
          className="w-full text-red-600 border-red-200 hover:bg-red-50 font-semibold rounded-lg h-14 shadow-none"
          onClick={() => navigate("/products?sort=deals")}
          >
