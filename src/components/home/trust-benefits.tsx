...
const BENEFITS = [
  {
    ...
    description: "Every supplier and product undergoes a rigorous verification process.",
  },
  {
  ...
  },
  {
    ...
    description: "Coordinated delivery tracking across all 30 districts of Rwanda.",
  },
  {
    icon: <Headphones className="w-6 h-6" />,
    title: "Expert Support",
    description: "Dedicated account managers for large-scale construction projects.",
  },
];
