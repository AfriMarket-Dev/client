...
export const ModerationQueue: React.FC<ModerationQueueProps> = ({
	...
	<div className="lg:col-span-2 space-y-8">
		<div className="flex items-center justify-between border-b border-border pb-6">
			...
			<Button variant="ghost" className="font-heading font-bold uppercase text-xs tracking-widest text-muted-foreground hover:text-primary">
						...
						<div className="flex flex-col md:flex-row">
							<div className="p-8 flex-1">
								...
								<div className="flex items-center gap-8 text-[10px] font-heading font-bold text-muted-foreground uppercase tracking-widest">
									...
									<div className="flex items-center gap-2">
										<RiArrowRightLine size={14} className="text-muted-foreground/40" />
