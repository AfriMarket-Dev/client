...
export const CategoryCard: React.FC<CategoryCardProps> = ({
	...
	return (
		<AdminCard
			noPadding
			className="hover:border-primary/30 transition-all duration-300 flex flex-col group/card shadow-sm hover:shadow-xl rounded-xl overflow-hidden"
		>
			...
			<div className="px-5 py-4 flex items-center justify-between mt-auto bg-white/50">
				...
				<button className="h-10 px-5 hover:bg-primary hover:text-white rounded-lg transition-all text-primary font-semibold text-xs border border-primary/20 hover:border-primary flex items-center gap-2">
					<RiEyeLine size={16} />
					View All
				</button>
			</div>
