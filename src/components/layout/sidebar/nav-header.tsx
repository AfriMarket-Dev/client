	...
	return (
		<SidebarMenu>
			<SidebarMenuItem>
				...
				>
					<div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-md overflow-hidden shrink-0">
						{info.logoUrl ? (
							<img
								src={info.logoUrl}
								alt={info.name}
