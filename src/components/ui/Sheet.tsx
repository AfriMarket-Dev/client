      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            side === "left" &&
              "data-ending-style:-translate-x-8 rtl:data-ending-style:translate-x-8 data-starting-style:-translate-x-8 rtl:data-starting-style:translate-x-8 w-[calc(100%-(--spacing(12)))] max-w-md border-e",
            side === "right" &&
              "col-start-2 w-[calc(100%-(--spacing(12)))] max-w-md border-s data-ending-style:translate-x-8 rtl:data-ending-style:-translate-x-8 data-starting-style:translate-x-8 rtl:data-starting-style:-translate-x-8",
            variant === "inset" &&
