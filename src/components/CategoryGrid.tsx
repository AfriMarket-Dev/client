    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <svg className="w-full h-full" viewBox="0 0 1200 800">
          ...
          <rect width="100%" height="100%" fill="url(#category-pattern)" className="text-orange-600"/>
        </svg>
      </div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {category.subcategories.slice(0, 3).map((sub, subIndex) => (
                    <span
                      key={subIndex}
                      className="px-3 py-1.5 bg-gradient-to-r from-orange-100 to-amber-100 text-orange-700 text-xs font-medium rounded-full border border-orange-200/50 hover:from-orange-200 hover:to-amber-200 transition-colors"
                    >
                      {sub}
                    </span>
                  ))}
