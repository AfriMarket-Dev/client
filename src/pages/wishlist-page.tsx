			...
			<div className="max-w-7xl mx-auto px-4 py-8">
				...
				{isLoading ? (
					...
					<div className="text-center py-20 bg-card rounded-sm border border-border">
						<RiHeartLine className="w-16 h-16 text-muted-foreground mx-auto mb-4 opacity-50" />
						...
						<Button onClick={() => navigate({ to: "/products" } as any)}>
							Browse Products
						</Button>
					</div>
				) : (
							...
							return (
								<Card key={listing.id} className="overflow-hidden">
									<div className="aspect-[4/3] bg-muted relative">
										...
										>
											<RiHeartFill className="w-4 h-4 fill-current text-destructive" />
										</Button>
									</div>
